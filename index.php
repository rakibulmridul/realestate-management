        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>D block,Bashundhara R/A</p>
              <p>The best place to find peace in your life</p>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Uttara sector 4</p>
              <p>The best place to find peace in your life</p>
              <cite> 20,000,000৳</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Kalabagan</p>
              <p>The best place to find peace in your life.</p>
              <cite> 20,000,000৳</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">4 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>Mirpur</p>
              <p>The best place to find peace in your life</p>
              <cite> 20,000,000৳</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">3 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>Gulshan 2</p>
              <p>The best place to find peace in your life</p>
              <cite> 20,000,000৳</cite>
              </blockquote>
            </div>
  ...
  <div class="properties-listing spacer"> <a href="list-properties.php" class="pull-right viewall">View All Listing</a>
    ...
    <div id="owl-example" class="owl-carousel">
      ...
      <div class="properties">
        ...
        <a class="btn btn-success" href="property-detail.php?id=<?php echo $id; ?>">View Details</a>
      </div>
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <h3>About Us</h3>
        <p>At Inert Tech Real Estate, you are number one. Whether you are a property owner, tenant, or buyer, we value your business and will provide you with the 
          individual attention and service you deserve. We believe in a strict Code of Ethics. We believe in integrity, commitment to excellence, 
          a professional attitude, and personalized care.<br><a href="about.html">Learn More</a></p>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>InertTech</b><br>
<span class="glyphicon glyphicon-envelope"></span>www.InertTech.com<br>
<span class="glyphicon glyphicon-earphone"></span> 01710000000</p>
            </div>
        </div>
<p class="copyright">Copyright 2022. All rights reserved By InertTech.	</p>
